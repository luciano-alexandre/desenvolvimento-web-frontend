# Encontro 33 — Projeto Final: requisitos e backlog

**Carga horária:** 1,5h  
**Entrega prevista:** Briefing e backlog

## Visão Geral

Este encontro desenvolve **Projeto Final: requisitos e backlog** como continuidade direta dos conhecimentos anteriores. A aula parte de um problema observável, apresenta os recursos necessários e termina com uma entrega que pode ser executada e verificada.
...
Problema deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 2) Usuários

Usuários deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 3) Histórias

Histórias deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 4) Critérios de aceite

Critérios de aceite deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 5) Priorização

Priorização deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
**Proposta:** Entregar briefing e backlog priorizado.
...
- demonstrar uso consciente de problema;
- demonstrar uso consciente de usuários;
- demonstrar uso consciente de histórias;
- demonstrar uso consciente de critérios de aceite;
- demonstrar uso consciente de priorização;
...
- [ ] Consigo explicar e aplicar **problema**.
- [ ] Consigo explicar e aplicar **usuários**.
- [ ] Consigo explicar e aplicar **histórias**.
- [ ] Consigo explicar e aplicar **critérios de aceite**.
- [ ] Consigo explicar e aplicar **priorização**.
...
Neste encontro, **Projeto Final: requisitos e backlog** foi tratado como parte de uma solução frontend completa. Conceitos, código, validação e comunicação técnica foram combinados para gerar um resultado reutilizável nos encontros seguintes e no projeto final.

## Questões de fixação

1. Como **problema** contribui para a solução desenvolvida?
<!-- Gabarito: definir problema, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

2. Como **usuários** contribui para a solução desenvolvida?
<!-- Gabarito: definir usuários, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

3. Como **histórias** contribui para a solução desenvolvida?
<!-- Gabarito: definir histórias, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

4. Como **critérios de aceite** contribui para a solução desenvolvida?
<!-- Gabarito: definir critérios de aceite, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

5. Como **priorização** contribui para a solução desenvolvida?
<!-- Gabarito: definir priorização, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
