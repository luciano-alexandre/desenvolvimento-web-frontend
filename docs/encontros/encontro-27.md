# Encontro 27 — Formulários reativos

**Carga horária:** 1,5h  
**Entrega prevista:** Formulário validado

## Visão Geral

Este encontro desenvolve **formulários reativos** como continuidade direta dos conhecimentos anteriores. A aula parte de um problema observável, apresenta os recursos necessários e termina com uma entrega que pode ser executada e verificada.
...
FormControl deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 2) FormGroup

FormGroup deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 3) Validators

Validators deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
Submit deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
**Proposta:** Construir cadastro tipado e validado.
...
- demonstrar uso consciente de FormControl;
- demonstrar uso consciente de FormGroup;
- demonstrar uso consciente de validators;
- demonstrar uso consciente de mensagens de erro;
- demonstrar uso consciente de submit;
...
- [ ] Consigo explicar e aplicar **FormControl**.
- [ ] Consigo explicar e aplicar **FormGroup**.
- [ ] Consigo explicar e aplicar **validators**.
- [ ] Consigo explicar e aplicar **mensagens de erro**.
- [ ] Consigo explicar e aplicar **submit**.
...
Neste encontro, **formulários reativos** foi tratado como parte de uma solução frontend completa. Conceitos, código, validação e comunicação técnica foram combinados para gerar um resultado reutilizável nos encontros seguintes e no projeto final.

## Questões de fixação

1. Como **FormControl** contribui para a solução desenvolvida?
<!-- Gabarito: definir FormControl, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

2. Como **FormGroup** contribui para a solução desenvolvida?
<!-- Gabarito: definir FormGroup, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

3. Como **validators** contribui para a solução desenvolvida?
<!-- Gabarito: definir validators, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

4. Como **mensagens de erro** contribui para a solução desenvolvida?
<!-- Gabarito: definir mensagens de erro, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

5. Como **submit** contribui para a solução desenvolvida?
<!-- Gabarito: definir submit, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
