# Encontro 26 — Roteamento

**Carga horária:** 1,5h  
**Entrega prevista:** Aplicação com rotas

## Visão Geral

Este encontro desenvolve **roteamento** como continuidade direta dos conhecimentos anteriores. A aula parte de um problema observável, apresenta os recursos necessários e termina com uma entrega que pode ser executada e verificada.
...
Routes deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 2) RouterLink

RouterLink deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 3) Parâmetros

Parâmetros deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 4) Rotas filhas

Rotas filhas deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 5) Fallback

Fallback deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
export const routes: Routes = [
  ...
  { path: "itens/:id", component: DetalheComponent },
...
**Proposta:** Criar lista, detalhe e página não encontrada.
...
- demonstrar uso consciente de routes;
- demonstrar uso consciente de routerLink;
- demonstrar uso consciente de parâmetros;
- demonstrar uso consciente de rotas filhas;
- demonstrar uso consciente de fallback;
...
- [ ] Consigo explicar e aplicar **routes**.
- [ ] Consigo explicar e aplicar **routerLink**.
- [ ] Consigo explicar e aplicar **parâmetros**.
- [ ] Consigo explicar e aplicar **rotas filhas**.
- [ ] Consigo explicar e aplicar **fallback**.
...
Neste encontro, **roteamento** foi tratado como parte de uma solução frontend completa. Conceitos, código, validação e comunicação técnica foram combinados para gerar um resultado reutilizável nos encontros seguintes e no projeto final.

## Questões de fixação

1. Como **routes** contribui para a solução desenvolvida?
<!-- Gabarito: definir routes, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

2. Como **routerLink** contribui para a solução desenvolvida?
<!-- Gabarito: definir routerLink, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

3. Como **parâmetros** contribui para a solução desenvolvida?
<!-- Gabarito: definir parâmetros, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

4. Como **rotas filhas** contribui para a solução desenvolvida?
<!-- Gabarito: definir rotas filhas, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

5. Como **fallback** contribui para a solução desenvolvida?
<!-- Gabarito: definir fallback, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
