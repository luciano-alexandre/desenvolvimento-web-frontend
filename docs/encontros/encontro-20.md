# Encontro 20 — Estudo de caso: conclusão e entrega

**Carga horária:** 1,5h  
**Entrega prevista:** Estudo de caso — 40 pontos

## Visão Geral

Este encontro desenvolve **estudo de caso — conclusão e entrega** como continuidade direta dos conhecimentos anteriores. A aula parte de um problema observável, apresenta os recursos necessários e termina com uma entrega que pode ser executada e verificada.
...
Requisitos deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 2) Planejamento

Planejamento deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 3) Implementação

Implementação deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 4) Validação

Validação deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 5) Entrega

Entrega deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
**Proposta:** Construir individualmente a interface do enunciado.
...
- demonstrar uso consciente de requisitos;
- demonstrar uso consciente de planejamento;
- demonstrar uso consciente de implementação;
- demonstrar uso consciente de validação;
- demonstrar uso consciente de entrega;
...
- [ ] Consigo explicar e aplicar **requisitos**.
- [ ] Consigo explicar e aplicar **planejamento**.
- [ ] Consigo explicar e aplicar **implementação**.
- [ ] Consigo explicar e aplicar **validação**.
- [ ] Consigo explicar e aplicar **entrega**.
...
Neste encontro, **estudo de caso — conclusão e entrega** foi tratado como parte de uma solução frontend completa. Conceitos, código, validação e comunicação técnica foram combinados para gerar um resultado reutilizável nos encontros seguintes e no projeto final.

## Questões de fixação

1. Como **requisitos** contribui para a solução desenvolvida?
<!-- Gabarito: definir requisitos, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

2. Como **planejamento** contribui para a solução desenvolvida?
<!-- Gabarito: definir planejamento, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

3. Como **implementação** contribui para a solução desenvolvida?
<!-- Gabarito: definir implementação, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

4. Como **validação** contribui para a solução desenvolvida?
<!-- Gabarito: definir validação, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

5. Como **entrega** contribui para a solução desenvolvida?
<!-- Gabarito: definir entrega, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
