# Encontro 25 — Serviços e injeção de dependência

**Carga horária:** 1,5h  
**Entrega prevista:** Serviço compartilhado

## Visão Geral

Este encontro desenvolve **serviços e injeção de dependência** como continuidade direta dos conhecimentos anteriores. A aula parte de um problema observável, apresenta os recursos necessários e termina com uma entrega que pode ser executada e verificada.
...
Serviços deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 2) Inject

Inject deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 3) Providers

Providers deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 4) Singleton

Singleton deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
**Proposta:** Mover regras compartilhadas para um serviço.
...
- demonstrar uso consciente de serviços;
- demonstrar uso consciente de inject;
- demonstrar uso consciente de providers;
- demonstrar uso consciente de singleton;
...
- [ ] Consigo explicar e aplicar **serviços**.
- [ ] Consigo explicar e aplicar **inject**.
- [ ] Consigo explicar e aplicar **providers**.
- [ ] Consigo explicar e aplicar **singleton**.
...
Neste encontro, **serviços e injeção de dependência** foi tratado como parte de uma solução frontend completa. Conceitos, código, validação e comunicação técnica foram combinados para gerar um resultado reutilizável nos encontros seguintes e no projeto final.

## Questões de fixação

1. Como **serviços** contribui para a solução desenvolvida?
<!-- Gabarito: definir serviços, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

2. Como **inject** contribui para a solução desenvolvida?
<!-- Gabarito: definir inject, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

3. Como **providers** contribui para a solução desenvolvida?
<!-- Gabarito: definir providers, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

4. Como **singleton** contribui para a solução desenvolvida?
<!-- Gabarito: definir singleton, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
