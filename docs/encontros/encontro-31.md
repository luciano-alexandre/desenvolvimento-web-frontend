# Encontro 31 — Angular com Tailwind CSS

**Carga horária:** 1,5h  
**Entrega prevista:** Interface estilizada

## Visão Geral

Este encontro desenvolve **angular com tailwind css** como continuidade direta dos conhecimentos anteriores. A aula parte de um problema observável, apresenta os recursos necessários e termina com uma entrega que pode ser executada e verificada.
...
Integração deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 2) Templates

Templates deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 3) Variantes

Variantes deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
Consistência deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
```html
<article class="rounded-xl border bg-white p-5 shadow-sm dark:bg-slate-900">
  <h2 class="text-lg font-bold">{{ item.nome }}</h2>
  <a [routerLink]="['/itens', item.id]" class="text-blue-700">Detalhes</a>
</article>
```
...
**Proposta:** Aplicar o tema Tailwind aos componentes Angular.
...
- demonstrar uso consciente de integração;
- demonstrar uso consciente de templates;
- demonstrar uso consciente de variantes;
- demonstrar uso consciente de responsividade;
- demonstrar uso consciente de consistência;
...
- [ ] Consigo explicar e aplicar **integração**.
- [ ] Consigo explicar e aplicar **templates**.
- [ ] Consigo explicar e aplicar **variantes**.
- [ ] Consigo explicar e aplicar **responsividade**.
- [ ] Consigo explicar e aplicar **consistência**.
...
Neste encontro, **angular com tailwind css** foi tratado como parte de uma solução frontend completa. Conceitos, código, validação e comunicação técnica foram combinados para gerar um resultado reutilizável nos encontros seguintes e no projeto final.

## Questões de fixação

1. Como **integração** contribui para a solução desenvolvida?
<!-- Gabarito: definir integração, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

2. Como **templates** contribui para a solução desenvolvida?
<!-- Gabarito: definir templates, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

3. Como **variantes** contribui para a solução desenvolvida?
<!-- Gabarito: definir variantes, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
...
5. Como **consistência** contribui para a solução desenvolvida?
<!-- Gabarito: definir consistência, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
