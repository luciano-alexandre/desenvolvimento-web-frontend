# Encontro 37 — Apresentações do Projeto Final

**Carga horária:** 1,5h  
**Entrega prevista:** Apresentação e demonstração do Projeto Final

## Visão Geral

Este encontro desenvolve **apresentações do projeto final** como continuidade direta dos conhecimentos anteriores. A aula parte de um problema observável, apresenta os recursos necessários e termina com uma entrega que pode ser executada e verificada.
...
Demonstração deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 2) Decisões técnicas

Decisões técnicas deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 3) Evidências

Evidências deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 4) Rubrica

Rubrica deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 5) Retrospectiva

Retrospectiva deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
**Proposta:** Apresentar o produto e a retrospectiva.
...
- demonstrar uso consciente de demonstração;
- demonstrar uso consciente de decisões técnicas;
- demonstrar uso consciente de evidências;
- demonstrar uso consciente de rubrica;
- demonstrar uso consciente de retrospectiva;
...
- [ ] Consigo explicar e aplicar **demonstração**.
- [ ] Consigo explicar e aplicar **decisões técnicas**.
- [ ] Consigo explicar e aplicar **evidências**.
- [ ] Consigo explicar e aplicar **rubrica**.
- [ ] Consigo explicar e aplicar **retrospectiva**.
...
Neste encontro, **apresentações do projeto final** foi tratado como parte de uma solução frontend completa. Conceitos, código, validação e comunicação técnica foram combinados para gerar um resultado reutilizável nos encontros seguintes e no projeto final.

## Questões de fixação

1. Como **demonstração** contribui para a solução desenvolvida?
<!-- Gabarito: definir demonstração, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

2. Como **decisões técnicas** contribui para a solução desenvolvida?
<!-- Gabarito: definir decisões técnicas, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

3. Como **evidências** contribui para a solução desenvolvida?
<!-- Gabarito: definir evidências, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

4. Como **rubrica** contribui para a solução desenvolvida?
<!-- Gabarito: definir rubrica, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

5. Como **retrospectiva** contribui para a solução desenvolvida?
<!-- Gabarito: definir retrospectiva, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
