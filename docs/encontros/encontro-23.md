# Encontro 23 — Control flow, diretivas e pipes

**Carga horária:** 1,5h  
**Entrega prevista:** Lista dinâmica

## Visão Geral

Este encontro desenvolve **control flow, diretivas e pipes** como continuidade direta dos conhecimentos anteriores. A aula parte de um problema observável, apresenta os recursos necessários e termina com uma entrega que pode ser executada e verificada.
...
@if deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 2) @for

@for deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 3) @switch

@switch deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 4) Pipes

Pipes deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 5) Track

Track deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
**Proposta:** Renderizar coleções e estados vazios.
...
- demonstrar uso consciente de @if;
- demonstrar uso consciente de @for;
- demonstrar uso consciente de @switch;
- demonstrar uso consciente de pipes;
- demonstrar uso consciente de track;
...
- [ ] Consigo explicar e aplicar **@if**.
- [ ] Consigo explicar e aplicar **@for**.
- [ ] Consigo explicar e aplicar **@switch**.
- [ ] Consigo explicar e aplicar **pipes**.
- [ ] Consigo explicar e aplicar **track**.
...
Neste encontro, **control flow, diretivas e pipes** foi tratado como parte de uma solução frontend completa. Conceitos, código, validação e comunicação técnica foram combinados para gerar um resultado reutilizável nos encontros seguintes e no projeto final.

## Questões de fixação

1. Como **@if** contribui para a solução desenvolvida?
<!-- Gabarito: definir @if, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

2. Como **@for** contribui para a solução desenvolvida?
<!-- Gabarito: definir @for, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

3. Como **@switch** contribui para a solução desenvolvida?
<!-- Gabarito: definir @switch, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

4. Como **pipes** contribui para a solução desenvolvida?
<!-- Gabarito: definir pipes, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

5. Como **track** contribui para a solução desenvolvida?
<!-- Gabarito: definir track, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
