# Encontro 24 — Comunicação entre componentes

**Carga horária:** 1,5h  
**Entrega prevista:** Componentes integrados

## Visão Geral

Este encontro desenvolve **comunicação entre componentes** como continuidade direta dos conhecimentos anteriores. A aula parte de um problema observável, apresenta os recursos necessários e termina com uma entrega que pode ser executada e verificada.
...
Input deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 2) Output

Output deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 3) Eventos customizados

Eventos customizados deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 4) Componente pai

Componente pai deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.

### 5) Fluxo unidirecional

Fluxo unidirecional deve ser identificado no exemplo, aplicado na prática e relacionado ao resultado observado. Compare uma versão incompleta com a versão corrigida, explique a sintaxe relevante e registre quando esse recurso deve ou não ser utilizado.
...
**Proposta:** Separar lista e item com dados e eventos.
...
- demonstrar uso consciente de input;
- demonstrar uso consciente de output;
- demonstrar uso consciente de eventos customizados;
- demonstrar uso consciente de componente pai;
- demonstrar uso consciente de fluxo unidirecional;
...
- [ ] Consigo explicar e aplicar **input**.
- [ ] Consigo explicar e aplicar **output**.
- [ ] Consigo explicar e aplicar **eventos customizados**.
- [ ] Consigo explicar e aplicar **componente pai**.
- [ ] Consigo explicar e aplicar **fluxo unidirecional**.
...
Neste encontro, **comunicação entre componentes** foi tratado como parte de uma solução frontend completa. Conceitos, código, validação e comunicação técnica foram combinados para gerar um resultado reutilizável nos encontros seguintes e no projeto final.

## Questões de fixação

1. Como **input** contribui para a solução desenvolvida?
<!-- Gabarito: definir input, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

2. Como **output** contribui para a solução desenvolvida?
<!-- Gabarito: definir output, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

3. Como **eventos customizados** contribui para a solução desenvolvida?
<!-- Gabarito: definir eventos customizados, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

4. Como **componente pai** contribui para a solução desenvolvida?
<!-- Gabarito: definir componente pai, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->

5. Como **fluxo unidirecional** contribui para a solução desenvolvida?
<!-- Gabarito: definir fluxo unidirecional, indicar sua finalidade e relacioná-lo ao exemplo e à prática. -->
