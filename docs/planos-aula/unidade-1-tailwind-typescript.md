...
- diagnosticar e recuperar conhecimentos prévios;
...
### Encontros 8 a 14 — JavaScript e Prática 2
...
- diagnóstico com código produzido na disciplina anterior;
- live coding em pequenas etapas;
- comparação entre CSS autoral e utilitários Tailwind;
...
A recuperação ocorre de forma contínua por retomadas, correções comentadas, exercícios equivalentes e refatoração de entregas. As regras formais devem seguir a organização acadêmica vigente.
